...
# ╔═╡ a4d00af9-2ff7-408e-866b-fd8ca216f15c
function truth(col)
	max = -1
	maxIndex = -1
...
# ╔═╡ bfedb581-a109-4071-b152-3c52c8180ed4
begin
	ids = rand(1:10000, 20)
...
@bind image_index Slider(ids, default=1)

# ╔═╡ a2470504-1a08-40aa-a03e-e10073334f0b
begin
	assess = truth(res[:,image_index])
	assess2 =truth(res[:,image_index]) ==test_y[image_index] ? "\u2713" : "\u2717"
	plot(image(test_x[:,:,:,image_index]),plot_title=string("actual: "*string(test_y[image_index]))*"   "*"Predicted: "*string(assess)*assess2)
end
...
begin
	...
	DataFrame(accuracy=(class_correct ./ class_total), label=labels)
end
